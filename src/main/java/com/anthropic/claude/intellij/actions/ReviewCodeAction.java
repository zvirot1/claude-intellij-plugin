...
/**
 * Action that sends the selected code to Claude with a request to review it
 * for bugs, issues, and potential improvements.
 */
public class ReviewCodeAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String message = "Review this code for bugs, issues, and improvements:\n\n```\n" + selectedText + "\n```";

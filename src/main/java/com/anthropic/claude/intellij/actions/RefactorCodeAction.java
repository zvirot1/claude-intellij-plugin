...
/**
 * Action that sends the selected code to Claude with a request to refactor it
...
public class RefactorCodeAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String message = "Refactor this code to improve readability and maintainability:\n\n```\n" + selectedText + "\n```";
